...
AUTHOR_ALIASES = {"Jakubzick C": "Jakubzick CV", "Randolph G": "Randolph GJ", "Gibbings S": "Gibbings SL", "Atif S": "Atif SM", "Kolling F": "Kolling FW", "Knolling F 4th": "Kolling FW", "Ringelberg C": "Ringelberg CS", "Redente E": "Redente EF", "Riches D": "Riches DW", "Martin T": "Martin TR"}
...
def paper_page(r, s, tax, related):
    ...
    ld = {"@context": "https://schema.org", "@type": "ScholarlyArticle", "headline": title, "name": title, "url": url,
          ...
          "publisher": {"@type": "Organization", "name": "Jakubzick Laboratory, Geisel School of Medicine at Dartmouth"}}
    if pdf:
...
def rss(items):
    ...
    out = ['<?xml version="1.0" encoding="UTF-8"?>', '<rss version="2.0"><channel>', f"<title>Jakubzick Lab: new papers</title><link>{SITE_URL}/</link>",
           "<description>New publications from the Jakubzick Laboratory at the Geisel School of Medicine at Dartmouth.</description>", f"<lastBuildDate>{now}</lastBuildDate>"]
    for r in items:
...
def main():
    ...
    newp = [{"id": s["id"], "t": s["t"], "a": s["a"], "y": s["y"], "j": s["j"], "added": s["added"], "pending": False} for s in index if s["added"] and s["added"] >= cutoff and s["added"] > "2026-09-09"]
    ...
    pages = [("", "weekly", "1.0"), ("publications.html", "daily", "0.9"), ("research.html", "monthly", "0.8"), ("people.html", "monthly", "0.8"), ("news.html", "daily", "0.7"),
             ("network.html", "weekly", "0.5"), ("bibliometrics.html", "weekly", "0.5"), ("join.html", "monthly", "0.6"), ("about.html", "monthly", "0.5")]
