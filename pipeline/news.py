"""Jakubzick Lab in the news: news stories, podcast episodes and blog posts about the lab and its work.
...
KEEP_DAYS = 180
RELEVANT = re.compile(r"jakubzick|dartmouth|geisel", re.I)
