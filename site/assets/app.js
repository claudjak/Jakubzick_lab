/* Jakubzick Lab site: shared front-end logic (no build step). Data files are generated by pipeline/build_site.py. */
window.CL = (function () {
  ...
  const LIST_KEY = "jakubzicklab.mylist.v1";
  const list = {
    _ids: null,
    ...
    export() { return JSON.stringify({ site: "jakubzicklab", exported: new Date().toISOString().slice(0, 10), ids: [...this.ids()] }, null, 1); },
  };
  function starBtn(id) {
    return "";  // reading lists are not enabled on this site
  ...
  const LINK_LABELS = { pdf: "PDF", publisher: "Publisher", fulltext: "Free full text", maps: "Maps", paradigm: "Paradigm", code: "Code", data: "Data", video: "Video", supplement: "Supplement", preprint: "Preprint", slides: "Slides", other: "Link" };
  ...
  function exportRefs(recs, fmt, name = "jakubzicklab") {
